...
interface Props {
  showChild: boolean;
  toggleDrawer: (anchor: string, open: boolean) => any;
  onClick: () => void;
...
const SubMenuLists: React.FC<Props> = ({
  showChild,
  onClick,
  icon,
  title,
  ...
  return (
    <>
      <div
        className="flex justify-between w-full items-center border-b-[1] border-gray-400 px-7 gap-3 shadow-sm py-1 cursor-pointer h-min text-gray-800"
        onClick={onClick}
      >
