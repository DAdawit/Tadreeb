        ...
        <div className="-mt-4 overflow-x-hidden">
          <Slider {...settings}>
            {this.props.carosoles.map((carosole) => (
              <div
                className="h-[90vh] relative xl:max-h-[80vh] xll:max-h-[60vh]"
                key={carosole.id}
              >
                <Image
                      ...
                      <div className="max-w-3xl xxl:max-w-4xl mx-auto grid ">
                        <div className="align-middle sm:pl-8">
                          ...
                          <p className="text-sm mt-8 xxl:text-lg ">
                            Our organization provides customized development
                            plans for professionals across diverse fields. These
                            programs are designed to cater to varying levels of
                            expertise, allowing participants to acquire the
                            necessary skills while considering their career
                            advancement
                          </p>
                        </div>
